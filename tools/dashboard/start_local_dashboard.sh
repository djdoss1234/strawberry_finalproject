...
export DASHBOARD_JOINT_GUARD="${DASHBOARD_JOINT_GUARD:-true}"
export DASHBOARD_JOINT_GUARD_MARGIN_DEG="${DASHBOARD_JOINT_GUARD_MARGIN_DEG:-8.0}"
export DASHBOARD_JOINT_GUARD_CLEAR_MARGIN_DEG="${DASHBOARD_JOINT_GUARD_CLEAR_MARGIN_DEG:-12.0}"
export DASHBOARD_CLEAR_PENDING_ON_START="${DASHBOARD_CLEAR_PENDING_ON_START:-true}"
...
echo "[dashboard] joint guard: $DASHBOARD_JOINT_GUARD margin=${DASHBOARD_JOINT_GUARD_MARGIN_DEG}° clear=${DASHBOARD_JOINT_GUARD_CLEAR_MARGIN_DEG}°"
echo "[dashboard] clear pending on start: $DASHBOARD_CLEAR_PENDING_ON_START"
